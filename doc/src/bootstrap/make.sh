...
doconce format html bootstrap_demo --html_style=bootstrap --html_template=template_$style.html --html_toc_depth=8 --html_admon=bootstrap_panel --html_output=$style --html_code_style=inherit

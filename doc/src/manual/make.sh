...
# doconce html format:
system doconce format html manual.do.txt --no_mako --html_style=bootswatch_readable --no_abort --html_code_style=inherit
...
doconce sphinx_dir copyright=HPL title='Doconce Manual' theme=cbc version=1.0 intersphinx manual.do.txt

...
system doconce format latex testdoc --without_answers --without_solutions $ex -DSOMEVAR --sections_down --latex_quiz_choice=number+circle --number_all_equations --latex_packages=refcount,ifthen
...
system doconce format latex testdoc.do.txt $ex --latex_title_layout=std --latex_packages=refcount,ifthen

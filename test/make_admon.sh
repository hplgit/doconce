...
doconce format html admon --html_style=bootstrap --pygments_html_style=default --html_template=style_vagrant/template_vagrant.html --toc_depth=2 --html_toc_indent=0
if [ $? -ne 0 ]; then echo "make.sh: abort"; exit 1; fi

...
Springer_sv: Springer's svmono class (new standard for all Springer books),
Springer_T2: Springer's T2 book style (replaced by T4),
Springer_T4: Springer's T4 book style,
...
tufte-book: use of tufte-book.cls for Edvard Tufte inspired layout,
